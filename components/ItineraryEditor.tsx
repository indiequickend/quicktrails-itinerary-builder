...
type DayItemType = 'Activity' | 'Transfer' | 'Meal' | 'Stay' | 'Note';
...
type ItineraryDoc = ItineraryTemplate & { days?: DayPlan[]; $id?: string };
...
export default function ItineraryEditor({ mode, itineraryId }: Props) {
    ...
    return (
        <div className="flex gap-4 h-[calc(100vh-80px)]">
            {/* Preview 60% */}
            <div ref={previewRef} className="w-3/5 overflow-y-auto border rounded bg-white">
                ...
                <div className='flex items-center justify-center my-4' data-export-block>
                    <img src="/images/divider.png" className="w-lg opacity-30 " alt="Divider" />
                </div>
